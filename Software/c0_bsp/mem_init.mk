...
$(MEM_0)_END := 0x00188b7f
$(MEM_0)_SPAN := 0x00088b80
$(MEM_0)_HIERARCHICAL_PATH := c0_ram
$(MEM_0)_WIDTH := 32
...
.PHONY: c0_ram
c0_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: c0_rom
MEM_1 := nios_multicore_c0_rom
$(MEM_1)_NAME := c0_rom
...
$(MEM_1)_END := 0x00015f8f
$(MEM_1)_SPAN := 0x00015f90
$(MEM_1)_HIERARCHICAL_PATH := c0_rom
$(MEM_1)_WIDTH := 32
...
.PHONY: c0_rom
c0_rom: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
