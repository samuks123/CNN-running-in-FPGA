...
JDI_FILE := C:/Users/pedro/OneDrive/Documentos/CNN-paralel/Quartus/Synthesis.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := C:/Users/pedro/OneDrive/Documentos/CNN-paralel/Quartus/nios_multicore.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios_multicore
SOPC_NAME := nios_multicore
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x21008
SOPC_SYSID_FLAG += --sidp=0x21008
ELF_PATCH_FLAG  += --sidp 0x21008

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1718198505
SOPC_SYSID_FLAG += --timestamp=1718198505
ELF_PATCH_FLAG  += --timestamp 1718198505
...
# setting hal.stderr is c0_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev c0_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is c0_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev c0_jtag_uart
...
# setting hal.stdout is c0_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev c0_jtag_uart
